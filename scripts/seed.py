...
# Load directly from pantheon.env
...
def build_and_push_agent(agent_index: int, demographic: str, age: int, region: str, retries: int = 3):
    ...
    user_prompt = (
        ...
        f"Align meticulously with the Medanese cultural context — business mentality, clan pride, "
        f"food culture, kampung community, strict upbringing, and the tension between tradition and modernity.\n"
...
def main():
    target_demographic = "Medanese Middle-Upper Class, 25-45"
    region = "Medan, Indonesia"
    num_agents = 5

    print(f"\n🚀 Starting Genesis Protocol: Seeding {num_agents} agents for '{target_demographic}'...")
